...
public class ContractController {
   ...
   /* @GetMapping("/search")
    ...
    public ResponseEntity<String> triggerContractExpirationCheck() {
        contractService.checkContractExpirations();
        return ResponseEntity.ok("✅ Vérification des contrats expirants déclenchée manuellement.");
    }
    // ✅ Modifier un contrat
    @PutMapping("/{id}")
    ...
    public ResponseEntity<Map<String, List<Contract>>> getContractsGroupedByMonth() {
        Map<String, List<Contract>> grouped = contractService.getContractsGroupedByMonth();
